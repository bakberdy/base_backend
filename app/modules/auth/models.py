...
class UserDevice(Base):
    ...
    login_requests: Mapped[list[LoginRequest]] = relationship(back_populates="user_device")
    sessions: Mapped[list[UserSession]] = relationship(back_populates="user_device")
...
class LoginRequest(Base):
    ...
    user_device: Mapped[UserDevice] = relationship(back_populates="login_requests")
...
class UserSession(Base):
    ...
    user_device: Mapped[UserDevice] = relationship(back_populates="sessions")
